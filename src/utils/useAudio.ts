import bmHigh from '../assets/b-m-high.mp3?url';
import fTone from '../assets/f.mp3?url';
import dmTone from '../assets/d-m.mp3?url';
import bmLow from '../assets/b-m-low.mp3?url';
